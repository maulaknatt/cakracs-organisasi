        ...
        <div class="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-slate-900/40 dark:bg-slate-950/40 backdrop-blur-md animate-fade-in"
            ...
            <div @click.outside="document.getElementById('modal-close-btn').click()"
                 ...
                 <div class="px-6 py-5 border-b border-slate-100 dark:border-white/5 flex items-center justify-between bg-slate-50/50 dark:bg-transparent">
                     <div>
                         <h2 class="text-xl font-black text-slate-800 dark:text-white tracking-tight">Buat Pengumuman</h2>
                         <p class="text-[13px] font-medium text-slate-500 dark:text-slate-400 mt-1">Bagikan informasi terbaru ke seluruh organisasi</p>
                     </div>
                 ...
                 <div class="p-6 sm:p-8 overflow-y-auto custom-scrollbar flex-1">
                     <form action="{{ route('pengumuman.store') }}" method="POST" data-turbo-frame="_top" class="space-y-6">
                         @csrf
                         ...
                         <div>
                             ...
                             <input type="text" id="judul" name="judul" value="{{ old('judul') }}"
                                    ...
                                    placeholder="Contoh: Jadwal Kegiatan Ramadhan" required autofocus>
                         ...
                         <div>
                             ...
                             <textarea id="isi" name="isi" rows="5"
                                       ...
                                       placeholder="Tuliskan informasi lengkap di sini..." required>{{ old('isi') }}</textarea>
                         ...
                         <div class="pt-6 flex items-center justify-end gap-3 border-t border-slate-100 dark:border-white/5">
                             ...
                             <button type="submit" 
                                     class="px-6 h-11 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[13px] rounded-xl shadow-lg shadow-blue-500/30 dark:shadow-blue-500/20 active:scale-95 transition-all">Publish Pengumuman</button>
                         </div>
                     </form>
                 </div>
